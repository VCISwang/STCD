...
class DSIFN(nn.Module):
    ...
    def forward(self, t1_input, t2_input):
        ...
        outputs.append(self.sigmoid(self.o1_conv3(x)))
        ...
        outputs.append(self.sigmoid(self.o2_conv4(x)))
        ...
        outputs.append(self.sigmoid(self.o3_conv4(x)))
        ...
        outputs.append(self.sigmoid(self.o4_conv4(x)))
        ...
        # outputs.append(self.sigmoid(self.o5_conv4(x)))
...
if __name__ == "__main__":
    ...
    IFNet = DSIFN(base_model, base_model)
    output_tensor = IFNet(t1, t2)
    print(IFNet)
    pass
