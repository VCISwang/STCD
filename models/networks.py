...
from models.SiamUnet_sub import SiamUnet_sub
from models.SiamUnet_diff import SiamUnet_diff
from models.SiamUnet_conc import SiamUnet_conc
from models.SiamUnet_crossconc import SiamUnet_cross_conc
from models.DTCDSCN import CDNet34
from models.DSIFN import DSIFN, vgg16_base
from models.SNUNet import SNUNet_ECAM
from models.ChangeVIG import ChangeGNNV1, ChangeGNNV2, ChangeGNNV2_Compare, VIG_V20_2
###############################################################################
# Helper Functions
###############################################################################
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif args.net_G == "SiamUnet_sub":
        net = SiamUnet_sub(input_nbr=3, label_nbr=args.n_class)
    elif args.net_G == "SiamUnet_abs":
        net = SiamUnet_diff(input_nbr=3, label_nbr=args.n_class)
    elif args.net_G == "SiamUnet_conc":
        net = SiamUnet_conc(input_nbr=3, label_nbr=args.n_class)
    elif args.net_G == "SiamUnet_cross_conc":
        net = SiamUnet_cross_conc(input_nbr=3, label_nbr=args.n_class)

    # The implementation of the paper
    # "Building Change Detection for Remote Sensing Images
    # Using a Dual Task Constrained Deep Siamese Convolutional Network Model "
    # Code copied from: https://github.com/fitzpchao/DTCDSCN
    elif args.net_G == "DTCDSCN":
        net = CDNet34(in_channels=3, num_classes=args.n_class)
    ...
    # https://github.com/GeoZcx/A-deeply-supervised-image-fusion-network-for-change-detection-in-remote-sensing-images
        ...
        net = DSIFN(base_model, base_model)

    elif args.net_G == "SNUNet":
        net = SNUNet_ECAM(in_ch=3, out_ch=args.n_class)
    ...
    # GNN
    elif args.net_G == "ChangeGNNV1":
        net = ChangeGNNV1(embed_dim=args.embed_dim)
    elif args.net_G == "ChangeGNNV2":
        net = ChangeGNNV2(embed_dim=args.embed_dim, img_size=args.img_size)
    elif args.net_G == "ChangeGNNV2_sub":
        net = ChangeGNNV2_Compare(embed_dim=args.embed_dim, img_size=args.img_size, diff_mode="sub")
    elif args.net_G == "ChangeGNNV2_abs":
        net = ChangeGNNV2_Compare(embed_dim=args.embed_dim, img_size=args.img_size, diff_mode="abs")
    elif args.net_G == "ChangeGNNV2_conc":
        net = ChangeGNNV2_Compare(embed_dim=args.embed_dim, img_size=args.img_size, diff_mode="conc")

    elif args.net_G == "GNN":
        net = VIG_V20_2(embed_dim=args.embed_dim)
