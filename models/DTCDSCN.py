...
class CDNet_model(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # output = []
        # output.append(self.sigmoid(out))

        return out


def CDNet34(in_channels, num_classes, **kwargs):

    model = CDNet_model(in_channels, SEBasicBlock, [3, 4, 6, 3], num_classes, **kwargs)

    return model


if __name__ == "__main__":
    net = CDNet34(in_channels=3, num_classes=1)
